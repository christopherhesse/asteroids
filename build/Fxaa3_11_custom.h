...
============================================================================*/
    ...
    #define FxaaFloat highp float
    #define FxaaFloat2 highp vec2
    #define FxaaFloat3 highp vec3
    #define FxaaFloat4 highp vec4
    #define FxaaHalf highp float
    #define FxaaHalf2 highp vec2
    #define FxaaHalf3 highp vec3
    #define FxaaHalf4 highp vec4
